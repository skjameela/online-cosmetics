...
<div class="container-fluid">
  <img src="resources/images/logo2.png" width="35" height="35" class="d-inline-block align-top" alt="">
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>Modal Store</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item active dropdown text-color">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="category?categoryId=0" >All</a>
               <%
                   if(categoryDao.getAllCategory() != null)
    ...
    %>
      <ul class="navbar-nav ml-auto text-color">
       <li class="nav-item active">
        <div class="nav-link" data-toggle="modal" data-target=".forgetpasswordmodal"><b class="text-color">Reset password</b></div>
      </li> 
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
     ...
     <%
      if(user!=null)
      {
    	  List<Cart> l= cartDao.getCartByUserId(user.getId());
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
              Modal Store is a prominent e-commerce website that has gained significant recognition in the online retail industry. With its user-friendly interface and vast product range, it provides customers with a seamless shopping experience from the comfort of their own homes. The website showcases an extensive collection of products, ranging from fashion apparel and accessories to electronics, home goods, and much more.

              Modal Store prides itself on its commitment to eco-friendliness. The website promotes sustainable practices by offering eco-friendly products and partnering with environmentally conscious brands. It also emphasizes responsible packaging and shipping methods to minimize its carbon footprint.

              The website's intuitive navigation and robust search functionality make it effortless for customers to find their desired products quickly. The detailed product descriptions, high-resolution images, and customer reviews provide valuable insights, helping shoppers make informed purchasing decisions.
          </b>
        </p>
        </div>
      </div>
